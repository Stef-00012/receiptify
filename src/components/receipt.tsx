...
export default function Receipt({ receiptData }: Params) {
	...
	return (
		<div
			className={`${windowSize.width >= 618 ? "max-w-[618px]" : ""} mx-auto my-0 py-[25px]`}
		>
			<div
				ref={receiptElement}
				className="px-5 bg-[url('/images/receiptBackground.webp')] bg-repeat"
			>
				<h1
					style={{
						fontSize: headerFontSize,
					}}
					className="align-center font-bold mb-5"
				>
					{receiptData.cardHolder}&apos;S RECEIPT
				</h1>
				<h2
					style={{
						fontSize: fontSize,
				...
				<p
					...
					className="mt-0 my-0"
				>
					TOTAL TRACKS: {receiptData.totalTracks}
				</p>
					...
					<thead>
						<tr className="divider">
							<td
								...
								className="divider align-right text-nowrap"
								colSpan={4}
							>
